            ...
            <form class="space-y-gutter" id="registrationForm">
                ...
                <div class="space-y-base">
                    ...
                    <div class="relative group">
                        ...
                        <input class="w-full h-12 pl-12 pr-4 bg-surface-container-low border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-outline/50" id="name" name="name" placeholder="John Doe" required type="text">
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 py-xs">
                    <div class="relative flex items-center">
                        <input class="peer h-5 w-5 rounded border-outline-variant/50 text-primary focus:ring-primary/20 bg-surface-container-low cursor-pointer appearance-none checked:bg-primary checked:border-primary transition-all" id="terms" name="terms" required type="checkbox">
