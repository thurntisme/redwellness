...
<body class="bg-surface text-on-surface font-body-lg min-h-screen">
    ...
    <header class="fixed top-0 left-0 w-full z-50 bg-surface/80 backdrop-blur-md shadow-sm h-14">
        <nav class="flex justify-between items-center gap-sm h-full px-container-margin container mx-auto">
            ...
            <div class="flex items-center gap-sm">
                <a href="<?= url('login') ?>" class="text-primary font-label-caps text-label-caps active:scale-95 transition-transform">
                    LOG IN
                </a>
                <a href="<?= url('register') ?>" class="px-4 py-2 rounded-full bg-primary text-white font-label-caps text-label-caps active:scale-95 transition-transform">
                    GET STARTED
                </a>
            </div>
        </nav>
